...
const DetailsPanel = ({ call, handleResolve }: DetailsPanelProps) => {
    ...
    return (
        ...
        >
            <Card className="h-fit w-[420px] rounded-none border-0 border-r border-slate-200 shadow-2xl bg-white">
                ...
                <CardFooter className="px-4 pb-4 pt-2">
                    <div className="flex w-full flex-col space-y-2">
                        ...
                        <div className="mb-2 flex justify-between gap-2">
                            <Button
                                variant="default"
                                className="max-w-fit flex-1 items-center justify-center rounded-lg bg-blue-600 px-3 py-2 text-white font-semibold hover:bg-blue-700 hover:scale-105 transition-all duration-200 shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                                onClick={() => {
                                    toast({
                            ...
                            <Button
                                variant="default"
                                className="flex-1 items-center justify-center rounded-lg bg-red-600 px-3 py-2 text-white font-semibold hover:bg-red-700 hover:scale-105 transition-all duration-200 shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                                onClick={() => {
                                    toast({
                            ...
                            >
                                <FireExtinguisher className="mr-2 w-4 h-4" />
                                <span className="text-sm font-medium">
                                    Fire
                                </span>
                            </Button>
                            <Button
                                variant="default"
                                className="flex-1 items-center justify-center rounded-lg bg-emerald-600 px-3 py-2 text-white font-semibold hover:bg-emerald-700 hover:scale-105 transition-all duration-200 shadow-md disabled:opacity-50 disabled:cursor-not-allowed"
                                onClick={() => {
                                    toast({
                            ...
                            >
                                <Ambulance className="mr-2 w-4 h-4" />
                                <span className="text-sm font-medium">
                                    Medical
                                </span>
                            </Button>
